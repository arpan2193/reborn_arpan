                            ...
                            <div class="ec-vendor-dashboard-card ">
                                <div class="card-inr">
                                    ...
                                    <div class="add-form">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="itemstatus" value="for adoption-nursery+main">
                                            <label class="form-check-label" for="exampleRadios1">
                                                For Adoption - Nursery + Main Pages
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="itemstatus" value="for adoption-nursery">
                                            <label class="form-check-label" for="exampleRadios1">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="itemstatus" value="hidden/draft">
                                            <label class="form-check-label" for="exampleRadios2">
