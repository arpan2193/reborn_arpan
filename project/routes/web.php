...
Route::prefix('admin')->group(function () {
  ...
  Route::group(['middleware' => 'permissions:orders'], function () {
    ...
    Route::get('/orders/vendor/{vendorId}', 'Admin\OrderController@index')->name('admin-vendor-order');
  ...
  Route::group(['middleware' => 'permissions:products'], function () {
    ...
    Route::get('/products/vendor/{vendorId}', 'Admin\ProductController@index')->name('admin-vendor-prod-index');
  ...
  Route::group(['middleware' => 'permissions:vendors'], function () {
    ...
    // Vendor Products
    Route::get('/vendor/{vendorId}/products', 'Admin\ProductController@datatables')->name('admin-vendor-products');
  ...
  Route::group(['middleware' => 'permissions:menu_page_settings'], function () {
    ...
    Route::post('/page-settings/update/about', 'Admin\PageSettingController@aboutupdate')->name('admin-ps-about-update');
  });
...
Route::group(['middleware' => 'maintenance'], function () {
  ...
  Route::view('/vendor-login', 'front.vendorlogin')->name('front.vendorlogin');
  ...
  //@Neha ABOUT US SECTION
  Route::get('/about', 'Front\FrontendController@about')->name('front.about');
  // Route::get('/terms','Front\FrontendController@termscondiction')->name('front.about');
  //
