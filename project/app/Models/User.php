...
class User extends Authenticatable implements JWTSubject
{
    ...
    // protected $fillable = ['name', 'photo', 'zip', 'residency', 'city', 'state', 'country_id', 'address', 'address2', 'phone', 'fax', 'email', 'password', 'affilate_code', 'verification_link', 'shop_name', 'owner_name', 'shop_number', 'shop_address', 'reg_number', 'shop_message', 'is_vendor', 'shop_details', 'shop_image', 'f_url', 'g_url', 't_url', 'l_url', 'f_check', 'g_check', 't_check', 'l_check', 'shipping_cost', 'date', 'mail_sent','payments_accepted','paypal_address','order_thank_you_message','order_location','member_description','contact_request','layaway','return_refund_policy','general_ordering_information','is_subscribe'];
    protected $fillable = ['name','photo','zip','state','city','country_id','address','address2','phone','fax','email','password','remember_token','is_provider','status','verification_link','email_verified','affilate_code','affilate_income','shop_name','owner_name','shop_number','shop_address','reg_number','shop_message','shop_details','shop_image','f_url','g_url','t_url','l_url','is_vendor','f_check','g_check','t_check','l_check','mail_sent','shipping_cost','current_balance','date','ban','reborn_url','website_url','payments_accepted','paypal_address','order_thank_you_message','order_location','member_description','contact_request','layaway_state','layaway_policy','return_refund_policy','general_ordering_information','allow_contacts','is_subscribe','subscribe_expired'];
