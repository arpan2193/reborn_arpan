...
class Product extends Model
{
    ...
    // protected $fillable = ['user_id', 'category_id', 'product_type', 'affiliate_link', 'sku', 'name', 'photo', 'size', 'size_qty', 'size_price', 'color', 'details', 'price', 'policy', 'status', 'views', 'tags', 'featured', 'best', 'top', 'hot', 'latest', 'big', 'trending', 'sale', 'features', 'colors', 'meta_tag', 'meta_description', 'type', 'file', 'license', 'license_qty', 'link', 'platform', 'region', 'licence_type', 'measure', 'discount_date', 'is_discount', 'whole_sell_qty', 'whole_sell_discount', 'catalog_id', 'slug', 'sculpt', 'limited_edition', 'length_by_inch', 'length_by_centimeters', 'weight', 'artist', 'sculpture_by', 'kit_name', 'head_material', 'body_material', 'limb_material', 'age', 'gender', 'arms', 'legs', 'edition', 'eyes', 'eyes_material', 'lashes', 'hair', 'paint', 'weighting', 'skin_color', 'race', 'realborn', 'pacifier', 'pacifier_type', 'drink_wet', 'smoke_free_env', 'pet_free_env', 'certificate_of_auth_coa', 'ordering_information', 'return_policy', 'layaway_available', 'shipping_charges'];

    protected $fillable = ['sku','product_type','affiliate_link','user_id','category_id','subcategory_id','attributes','name','slug','photo','thumbnail','file','size','price','previous_price','description','stock','length_unit','status','views','tags','features','product_condition','ship','is_meta','meta_tag','meta_description','youtube','type','link','platform','region','shipping_condn','measure','featured','best','top','hot','latest','big','trending','sale','is_discount','postedbefore','is_catalog','catalog_id','sculpt','limited_edition','length','length_by_centimeters','item_type','sub_item_type','itemstatus','afteradopted','reborned','makecustombaby','neworold','weight','artist','sculpture_by','kit_name','head_material','body_material','limb_material','age','gender','arms','legs','edition','eyes','lashes','hair','paint','weighting','skin_color','race','twin','realborn','pacifier','pacifier_type','booboo','drink_wet','smoke_free_env','pet_free_env','certificate_of_auth_coa','ordering_information','return_policy','layaway_available','shipping_charges','torso','private_notes','email_to_subscriber','prod_order'];
