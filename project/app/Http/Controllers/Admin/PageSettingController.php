...
class PageSettingController extends Controller
{
    ...
    // ABout Us Page Settings All post requests will be done in this method
    public function aboutupdate(Request $request)
    {
        ...
        // $model = new Custom_page;
        $data = Custom_page::findOrFail($request->pageId);
        // $data =  $model->where('slug','=','about')->first();
        // $input = $request->all();
        ...
        $input = [
            ...
            {
                $name =$request->previous_image;
                // dd($name);
                $input['featured_image'] = $name;
            }


        // $model->where('slug','=','about')->update($input);
        if($data->update($input)){
            $msg = 'Data Updated Successfully.';
            return response()->json($msg);
        }else{
            $msg = 'Data Update Unsuccessful.';
            return response()->json($msg);
        }
