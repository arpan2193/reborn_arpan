    ...
    $("#feature-section").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove feature-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-4">'+
                                            '<input type="text" name="shipping_charges[country_name][]" class="input-field" placeholder="Enter Country Name">'+
                                        '</div>' +
                                        '<div class="col-lg-4">'+
                                            '<input type="text" name="shipping_charges[shipping_cost][]" class="input-field" placeholder="Enter Shipping Cost">'+
                                        '</div>' +
                                        '<div class="col-lg-4">'+
                                            '<input type="text" name="shipping_charges[shipping_type][]" class="input-field" placeholder="Enter Shipping Type">'+
                                        '</div>'+
                                    '</div>'+
                            '</div>'
                            +'');
